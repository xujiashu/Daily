...
static void AddNode(Node * new_node, Node * root)  //call ToLeft ToRight
{
...
bool AddItem(const Item * pi, Tree * ptree)  //call SeekItem MakeNode AddNode
{
  Node * new_node;
  if(TreeIsFull(ptree))
  {
